        ...
        <div class="row">
            ...
            <div class="col col-sm-2">
                <select name="order_direction" class="form-select">
                    <option value="" <?php echo e(request()->order_direction == "" ? "selected" : ""); ?> disabled>Order Direction
                    </option>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col col-sm-12 col-lg-4">
                        <img src="<?php echo e(asset("images/$product->photo")); ?>" class="img-thumbnail" alt="<?php echo e($product->name); ?>"
                            width="100%">
                    </div>
                    <div class="col col-sm-12 col-lg-8 mt-3">
                        <div class="row mb-2">
                            ...
                            <div class="col col-2">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_products')): ?>
                                    <a href="<?php echo e(route('products_delete', $product->id)); ?>"
                                        class="btn btn-danger form-control">Delete</a>
                                <?php endif; ?>
                            </div>
                            <div class="col col-2">
                                <?php if(auth()->check() && !auth()->user()->can('edit_products') && !auth()->user()->can('delete_products')): ?>
                                    <?php if($product->stock != 0): ?>
                                        <form action="<?php echo e(route('bought_products_list')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th>Quantity</th>
                                <td><?php echo e($product->stock); ?> <?php echo e($product->stock == 0 ? '(Out of Stock)' : ''); ?></td>
                            </tr>
                            <tr>
                                <th>Price</th>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mega Store\Downloads\Telegram Desktop\websec-main\WebSecService\resources\views/products/list.blade.php ENDPATH**/ ?>