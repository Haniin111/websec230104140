    ...
    <form action="<?php echo e(route('products_save', $product->id)); ?>" method="post">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                ...
                <input type="number" class="form-control" name="stock" required value="<?php echo e($product->stock ?? 0); ?>" min="0">
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\websec-main\WebSecService\resources\views/products/edit.blade.php ENDPATH**/ ?>