<nav class="navbar navbar-expand-sm bg-light">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <ul class="navbar-nav">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-employees')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('employees.create')); ?>">Create Employee</a>
                    </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-customers')): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('employees.customers')); ?>">Customers</a>
                    </li>
                <?php endif; ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('users.profile')); ?>">Profile</a>
                </li>
                <?php if(auth()->check()): ?>
                    <li class="nav-item">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('users.profile')); ?>"><?php echo e(auth()->user()->name); ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('do_logout')); ?>">Logout</a>
            </li>
...
</nav><?php /**PATH C:\Users\Mega Store\Downloads\websec-main\WebSecService\resources\views/layouts/menu.blade.php ENDPATH**/ ?>